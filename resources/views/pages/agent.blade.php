...
@section('content')
    ...
    <div class="row" style="margin: 30px;">
        <div class="col-md-4">
            <h3 class="page-title text-center">Agent Page
                <form action="{{url('logout')}}" method="post">
                    @csrf
                    <input type="hidden" name="type" value="{{Session::get('agentSessionData')}}">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$list->name}}</td>
                        <td>
                            <a href="{{route('agent.delete', $list->id)}}" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger btn-sm"> Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
